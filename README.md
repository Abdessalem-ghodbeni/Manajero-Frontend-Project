...
Bienvenue dans le dépôt "Manajero". Nous sommes une équipe composée de Ghodbani Abdessalem, Balkiss Hmidi et Aymen Nefzi, actuellement en stage chez Ipact. Notre projet principal est de développer une solution de gestion de projet innovante intégrant la méthode Scaled Agile Framework (SAFe). Parmi les tâches principales de Manajero, nous visons à faciliter la gestion de projets complexes en suivant les normes et les meilleures pratiques du cadre SAFe. Ce dépôt contient les composants essentiels pour implémenter une gestion de projet structurée et efficace, permettant aux équipes de travailler de manière synchronisée et d'atteindre leurs objectifs avec agilité et précision. Nous espérons que Manajero deviendra un outil incontournable pour les organisations cherchant à améliorer leur efficacité opérationnelle et à maximiser la valeur livrée à leurs clients.
